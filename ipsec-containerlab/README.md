...
From this directory, build, deploy, and verify the complete lab with one command:
...
This removes the containers, virtual links, and files generated by Containerlab. `sudo make clean` additionally removes the local `ipsec-alpine:latest` image.
